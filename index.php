          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse float-right">
              <ul class="nav navbar-nav">
                ...
                <li><a href="javascript:void(0)" onclick="openLoginModal();"><span class="glyphicon glyphicon-log-in">Admin</a></li>
                <li><a href="javascript:void(0)" onclick="openLoginModal();"><span class="glyphicon glyphicon-log-in">User</a></li>
